...
const bxFundingRoadmap = [
  {
    ...
    use: '제품 고도화, 실증 운영, 출력 안정화, 성과 리포트 확보',
  },
  {
    stage: '2단계 | Seed 유치',
    timing: '2026.12~2027 상반기',
    funding: '가정 300,000,000원~500,000,000원',
    trigger: 'PoC 2건 완료, 유료전환 1건 이상, 보안/운영 표준안 확정',
    use: '초기 GTM 인력, 고객성공, 엔터프라이즈 보안 고도화, 전국 확산 채널 확보',
  },
  {
    stage: '3단계 | Series A 검토',
    timing: '2027 하반기~2028',
    funding: '가정 1,000,000,000원~2,000,000,000원',
    trigger: '반복매출 구조 확인, 유료 고객군 다변화, 채널 확장 재현성 확보',
    use: '본격 영업조직 구축, 공공조달 특화 기능, 파트너 세일즈 체계 확장',
  },
  {
    stage: '4단계 | Series B/전략투자',
    timing: '2028 이후',
    funding: '시장 확장 단계에서 별도 검토',
    trigger: '전국 확산, 공공조달·엔터프라이즈 확장, 대형 고객 비중 증가',
    use: '수직시장 확장, 전략적 인수 제휴, 대형 고객 전담 조직 구축',
  },
]
...
const bxFullSubmissionSections: BxFullSubmissionSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      '3-3. 추진 일정 및 자금 운용 3-3-1 전체 로드맵: ①2025~2026상반기 문제정의 및 MVP 검증(내부 테스트 50회, 초기 시장접점 확보) ②2026협약기간 Beta v1.0 완성/외부 실증 2건/성과 재현성 검증/도입 프로세스·요금체계 정리 ③2027이후 SaaS 상용화/공공조달 특화 기능/파트너 확장 및 반복매출 강화.',
      '<사업 추진 일정(전체)> MVP 검증·기능설계(2025.11~2026.03) / Beta 개발·고도화(2026.05~08) / 외부 실증 1·2차(2026.07~10) / 상용화 준비(2026.10~12) / SaaS 전환·시장 확대(2027년).',
      ...
      '③ 단계별 자금조달 계획: 1단계는 정부지원금 100,000,000원과 자기부담 43,000,000원으로 협약 산출물을 완수한다. 2단계는 실증 2건 완료와 유료전환 1건 이상 확보를 조건으로 2026년 4분기~2027년 상반기 중 Seed 투자를 추진한다. 목표 투자자는 엔젤투자자, 액셀러레이터, B2B SaaS·에듀테크·컨설팅 연계 전략적 투자자이며, 목표 조달규모는 가정상 300,000,000원~500,000,000원 수준으로 설정한다.',
      '④ 중장기 투자유치 방안: Seed 이후에는 반복매출 구조와 고객군 다변화가 확인되는 시점에 Series A를 검토한다. Series A는 2027년 하반기~2028년을 목표 시점으로 가정하고, 표준형 SaaS 확산, 공공조달 특화 기능, 파트너 세일즈 조직 확장을 위한 자금으로 활용한다. 이후 전국 확산과 대형 고객 비중 확대가 확인되면 Series B 또는 전략적 투자 유치를 선택적으로 검토한다.',
...
1단계는 정부지원금과 자기부담금으로 협약 산출물을 완수한다.
2단계는 실증 2건 완료, 유료전환 1건 이상, 보안·운영 표준안 확정을 조건으로 2026년 4분기~2027년 상반기 Seed 투자를 추진한다.
Seed 투자 목표는 가정상 300,000,000원~500,000,000원이며, 엔젤투자자, 액셀러레이터, B2B SaaS 및 전략적 투자자를 우선 접촉 대상으로 설정한다.
3단계는 반복매출 구조와 고객군 다변화가 확인되는 시점에 2027년 하반기~2028년 Series A를 검토한다.
Series A는 가정상 1,000,000,000원~2,000,000,000원 규모를 전제로 하며, 전국 확산 영업조직, 공공조달 특화 기능, 파트너 채널 확장에 사용한다.
Series B 또는 전략적 투자는 전국 확산과 대형 고객 확보가 확인된 이후 선택적으로 검토한다.
...
const bxFormMirrorSections: BxSectionItem[] = [
  ...
  },
  {
    ...
    execution: [
      ...
      '1단계는 정부지원금+자기부담으로 협약 산출물을 완료하고, 2단계는 실증 2건·유료전환 1건을 조건으로 Seed를 추진함.',
      'Seed 이후에는 반복매출 구조와 고객군 다변화를 확인한 뒤 Series A를 검토하고, 투자 지연 시에는 선매출·재투자·채용 조정으로 대응함.',
    ],
    metrics: [
