...
const bxFullSubmissionSections: BxFullSubmissionSection[] = [
  ...
  },
  {
    ...
    lines: [
      ...
      '3-3-3 자금 필요성 및 조달: 개발 인력·클라우드/모델비·출력 안정화·실증 운영비가 필요. 지원사업 외 자기부담 투입으로 운영 안정성 확보, 협약 종료 후 PoC/초기 SaaS 매출 재투자, 필요 시 Seed/전략 파트너 연계 검토(우선순위는 실증 레퍼런스와 초기 유료전환).',
